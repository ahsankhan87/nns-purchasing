...
class m_entries extends CI_Model{
    ...
    $date=null,$entry_no=null,$ref_id=0)
    {
        $data = array(
    ...
    {
        $this->db->select('g.title,g.title_ur,ei.date, ei.id,ei.entry_id,ei.account_code,ei.invoice_no,ei.debit,ei.credit,ei.narration,');
