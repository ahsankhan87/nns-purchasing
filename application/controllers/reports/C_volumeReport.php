...
class C_volumeReport extends MY_Controller{
    ...
    //     {
    //     $data['receivings'] = $this->M_pos_reports->receivings_report($data['from_date'],$data['to_date'],$_SESSION['company_id'],$supplier_id,$product_id);    
    //     }
    //                 //for logging
    //                 $msg = '';
    ...
    public function index(){
        ...
        $data['title'] = 'Volume Report';
        $data['main'] = 'Volume Report';
        
        $data['volume_of_items'] = $this->M_receivings->get_volume_of_items();
        
        $this->load->view('templates/header',$data);
        $this->load->view('reports/receivings/volume_report',$data);
        $this->load->view('templates/footer');
    }
}