...
class Items extends MY_Controller{
    ...
    function get_allItems($supplier_id='')
    {
        echo json_encode($this->M_items->get_allItems($supplier_id));
        //$this->load->view('pos/items/getItems',$data);
    }
    ...
    function create()
    {
        ...
        //{
            ...
            $data['shipping_termsDDL'] = $this->M_shipping_terms->get_activeshipping_termsDDL();
    ...
    public function item_transactions($item_id)
    {
        ...
        $data['title'] = 'Product Purchase History';
        $data['main'] = 'Product Purchase History';
       
        $data['items']= $this->M_items->get_item_history($item_id,FY_START_DATE,FY_END_DATE);
