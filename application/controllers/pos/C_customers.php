...
class C_customers extends MY_Controller{
    ...
    function get_active_customers_JSON()
    {
...
//                echo $prev_ExRate_total;
           ...
           if($discount_amount > 0)
           {
               ...
               $entry_id=$this->M_entries->addEntries($dr_dis_account,$cr_dis_account,$discount_amount,$discount_amount,$narration,$new_invoice_no,$date);
