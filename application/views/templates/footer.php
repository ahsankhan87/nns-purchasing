...
<script src="<?php echo base_url(); ?>assets/plugins/uniform/jquery.uniform.min.js1" type="text/javascript"></script>
<link href="<?php echo base_url(); ?>assets/plugins/uniform/css/uniform.default.css1" rel="stylesheet" type="text/css">
