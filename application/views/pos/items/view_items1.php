<div class="row">
    <div class="col-sm-12">
       ...
       <?php
        ...
        <div class="row">
            <div class="col-sm-12">
               <!-- <div class="btn-group">
                ...
                <!-- /btn-group -->
                <?php echo anchor('pos/Items/create',lang('add_new'),'class="btn btn-success"'); ?>
        ...
        <table class="table table-striped table-condensed table-hover table-bordered flip-content" id="getAllProducts">
            <thead class="flip-content">
                <tr>
                    ...
                    <!--<th class="text-right">USD Landed Cost</th>-->
                    <th class="text-right">PHP LC</th>
                    <th></th>
