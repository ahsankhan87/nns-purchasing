    ...
    <div class="col-md-12">
        <div class="portlet">
            ...
            <div class="portlet-body form">
                ...
                echo form_open('pos/C_suppliers/edit',$attributes);
                ...
                <div class="form-body">
                  ...
                  <!--
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3" for="supplier Name">Name:<span class="required">* </span></label>
                      <div class="col-md-9">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control" name="country" value="<?php echo $values['country'] ?>" placeholder="Country"  />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control" id="" name="contact_no" value="<?php echo $values['contact_no']; ?>" placeholder="Contact No"/>
                      </div>
                    </div>
                
                    <div class="form-group">
                      <label class="control-label col-md-3" for="Contactperson">Contact Person:</label>
                      <div class="col-md-9">
                        <input type="text" class="form-control" name="contact_person" value="<?php echo $values['contact_person'] ?>" placeholder="Contact Person"  />
                        
                      </div>
                    </div>
                
                    <div class="form-group">
                      <label class="control-label col-md-3" for="dtl_cost">DTL Cost:</label>
                      <div class="col-md-4">
                        <input type="number" class="form-control" name="dtl_cost" step="0.0001" value="<?php echo $values['dtl_cost'] ?>" placeholder="DTL Cost"  />
                        
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="control-label col-md-3" for="php_cost">PHP Cost:</label>
                      <div class="col-md-4">
                        <input type="number" class="form-control" name="php_cost" step="0.0001" value="<?php echo $values['php_cost'] ?>"  placeholder="PHP Cost"  />
