...
echo form_open($langs.'/pos/C_suppliers/create',$attributes);
...
<!--    <?php echo anchor('pos/PostingTypes/create_purchase','Add New <i class="fa fa-plus"></i>',''); ?>-->
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <textarea class="form-control" placeholder="Country" name="country"></textarea>
  </div>
</div>
...
<div class="form-group">
  <label class="control-label col-md-3" for="Contact">Contact Person:</label>
  <div class="col-md-4">
    <input type="text" class="form-control" name="contact_person" value="<?php echo set_value('contact_person') ?>" placeholder="Contact Person"  />
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <input type="number" class="form-control" name="dtl_cost" step="0.0001" value="<?php echo set_value('dtl_cost') ?>" placeholder="DTL Cost"  />
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <input type="number" class="form-control" name="php_cost" step="0.0001" value="<?php echo set_value('php_cost') ?>" placeholder="PHP Cost"  />
