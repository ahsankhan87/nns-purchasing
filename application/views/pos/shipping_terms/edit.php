...
echo form_open('pos/C_shipping_terms/edit',$attributes);

foreach($update_shipping_term as $row)
{
?>
<div class="form-group">
  <label class="control-label col-sm-2" for="Name">Shipping Term Name:</label>
  <div class="col-sm-10">
