<div class="row">
    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12">
                <?php echo anchor('hr_finance/C_time_requests/create',lang('add_new').' <i class="fa fa-plus"></i>','class="btn btn-success"'); ?>
            </div>
        </div>
        </br>
        ...
        <?php
        foreach($time_requests as $key => $list)
        {
            ...
            //if($_SESSION['role'] == 'admin'){
                echo anchor('hr_finance/C_time_requests/edit/'.$list['id'],'<i class="fa fa-pencil-square-o fa-fw"></i>'). ' | ';
                echo  anchor('hr_finance/C_time_requests/delete/'.$list['id'],' <i class="fa fa-trash-o fa-fw"></i>','onclick="return confirm(\'Are you sure you want to delete?\')"');
            //}
            echo '</td>';
            echo '</tr>';
        }
