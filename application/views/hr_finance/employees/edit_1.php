<div class="row profile">
	<div class="col-md-12">
        ...
        ?>
        <?php foreach($employee as $values): 
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="first_name" value="<?php echo $values['first_name']; ?>" class="form-control" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="middle_name" class="form-control"  value="<?php echo $values['middle_name']; ?>" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="last_name" value="<?php echo $values['last_name']; ?>"  class="form-control" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="suffix" class="form-control"  value="<?php echo $values['suffix']; ?>" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="nick_name" value="<?php echo $values['nick_name']; ?>"  class="form-control" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="gender" class="form-control"  value="<?php echo $values['gender']; ?>" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" name="dob" value="<?php echo $values['dob']; ?>" class="form-control" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="marital_status" class="form-control"  value="<?php echo $values['marital_status']; ?>" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="address" id="" class="form-control" ><?php echo $values['address']; ?></textarea>
                                                        </div>
                                                    </div>
                                                    <!--/span-->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="contact" class="form-control"  value="<?php echo $values['contact']; ?>" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="emp_no" value="<?php echo $values['emp_no']; ?>"  class="form-control" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="position" class="form-control"  value="<?php echo $values['position']; ?>" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" name="hire_date" value="<?php echo $values['hire_date']; ?>"  class="form-control" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="sss" value="<?php echo $values['sss']; ?>"  class="form-control" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="phil_health" class="form-control"  value="<?php echo $values['phil_health']; ?>" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="pag_ibig" value="<?php echo $values['pag_ibig']; ?>"  class="form-control" >
