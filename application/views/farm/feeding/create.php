<div class="row">
  <div class="col-sm-12">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <!--<?php echo form_dropdown('ibn_1', $ibnDDL, set_value('ibn_1'), 'class="form-control select2me" id="ibn_1"'); ?>-->
...
<script>
  $(document).ready(function() {
    ...
    $('#ibn_1').on('change', function() {
      ...
      $.ajax({
        url: site_url + "/farm/C_feeding/get_ibn_by_item_id/" + item_id + '/' + ibn_1,
        type: 'GET',
        dataType: 'json', // added data type
        success: function(data) {
          console.log(data);
