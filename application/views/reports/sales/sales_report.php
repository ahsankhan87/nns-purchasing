<div class="tabbable tabbable-custom">
	<ul class="nav nav-tabs">
		<li class="<?php echo $active_tab_0; ?>">
			<a href="#tab_0" data-toggle="tab">Sales Report</a>
		</li>
		<li class="<?php echo $active_tab_1; ?>">
			<a href="#tab_1" data-toggle="tab">Customer Wise Summary</a>
		</li>
		<li class="<?php echo $active_tab_2; ?>">
			<a href="#tab_2" data-toggle="tab">Product Wise Summary</a>
		</li>
        <li class="<?php echo $active_tab_3; ?>">
			<a href="#tab_3" data-toggle="tab">Customer Last Sales Report</a>
		</li>
        <li class="<?php echo $active_tab_4; ?>">
			<a href="#tab_4" data-toggle="tab">Category Wise Summary</a>
		</li>
	</ul>
        ...
        <div class="tab-pane <?php echo $active_tab_0; ?>" id="tab_0">
            ...
            <div class="row">
              ...
              <div class="portlet-body flip-scroll">  
                    <table class="table table-striped table-condensed table-hover flip-content" id="sample_sales_reports">
                    ...
                    foreach($sales_report as $key => $list)
                    {
                        ...
                        echo '<td>'.round($list['item_unit_price'],2).'</td>';
                        echo '<td>'.round($list['discount_value'],2).'</td>';
                        echo '<td>';
        ...
        <div class='row hidden-print'>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <table class="table table-striped table-condensed table-hover" id="sales_summary">
                        <thead>
                            <tr>
                                <th>Serial No</th>
                                <th>Customers</th>
                    ...
                    foreach($customerWise_sales_report as $key => $list)
                    {
                        ...
                        echo '<td>'.$sno++.'</td>';
                        echo '<td>'.$this->M_customers->get_CustomerName($list['customer_id']).'</td>';
                        echo '<td>'.($list['price']-$list['discount_value']).'</td>';
