...
var initGetAllProducts = function () {
        ...
        var oTable = table.dataTable({
            ...
            "columns": [
                        ...
                        { "data": "quoted_qty" },
                        { "data": "unit_name" },
                        { "data": "category" }, //{ "data": "shipping_terms" },
                        //{ "data": "landed_cost" },
                        { "data": "local_currency" },
                        { "data": "item_id" }
            ...
            "createdRow": function( nRow, aData, iDisplayIndex ) {
                            ...
                            $('td:eq(3)', nRow).html(parseFloat(aData['avg_cost']).toLocaleString('en-US',{minimumFractionDigits: 4}));
                            $('td:eq(4)', nRow).html(parseFloat(aData['quoted_qty']).toLocaleString('en-US'));
                            //$('td:eq(3)', nRow).html(parseFloat(aData['quantity']).toFixed(2));
                            //$('td:eq(6)', nRow).html(parseFloat(aData['landed_cost']).toFixed(2).toLocaleString('en'));
                            
                            $('td:eq(7)', nRow).html(parseFloat(aData['local_currency']).toLocaleString('en-US',{minimumFractionDigits: 2}));
                            ...
                            if(aData['service'] == parseInt("1")){
                                ...
                                $('td:eq(8)', nRow).html('<a href="'+site_url+'/pos/Items/editService/' + aData['item_id'] + 
                                ...
                                $('td:eq(8)', nRow).html('<a href="'+site_url+'/pos/Items/edit/' + aData['item_id'] + '/' + aData['size_id'] + 
